...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <header class="with-background">
            ...
            <div class="hero container">
                ...
                <div class="hero-image">
                    <img src="img/sdu.png" alt="hero image">
                </div> <!-- end hero-image -->
            </div> <!-- end hero -->
        </header>
        ...
        <div class="featured-section">
            ...
            <div class="container">
                <h1 class="text-center">SDU SHOP</h1>

                <p class="section-description">Place where you can buy SDU clothes.</p>

                <div class="text-center button-container">
                    <a href="/shop" class="button">Featured</a>
